...
class RestFunction19Spec extends FlatSpec with Matchers with MockitoSugar {
  
  val method = HttpMethod.GET
  val path = "/some/path"
  
  "Function19 wrapper" should "call the wrapped function with same parameters" in {
	  val function = mock[Function19[AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,
	    AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef]]
	  ...
	  val p17 = mock[AnyRef]; val p18 = mock[AnyRef]; val p19 = mock[AnyRef]
	  ...
	  val testObj = new RestFunction19(function, method, path, List(arg, arg, arg, arg, arg,
