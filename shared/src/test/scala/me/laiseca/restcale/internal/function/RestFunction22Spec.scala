...
class RestFunction22Spec extends FlatSpec with Matchers with MockitoSugar {
  
  val method = HttpMethod.GET
  val path = "/some/path"
  
  "Function22 wrapper" should "call the wrapped function with same parameters" in {
	  val function = mock[Function22[AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,
	  ...
	  val p21 = mock[AnyRef]; val p22 = mock[AnyRef]
	  ...
	  val testObj = new RestFunction22(function, method, path, List(arg, arg, arg, arg, arg,
