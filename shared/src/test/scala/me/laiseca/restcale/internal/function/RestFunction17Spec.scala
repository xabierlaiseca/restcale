...
class RestFunction17Spec extends FlatSpec with Matchers with MockitoSugar {
  
  val method = HttpMethod.GET
  val path = "/some/path"
  
  "Function17 wrapper" should "call the wrapped function with same parameters" in {
	  val function = mock[Function17[AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,
	    AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef,AnyRef]]
	  ...
	  val testObj = new RestFunction17(function, method, path, List(arg, arg, arg, arg, arg,
	      arg, arg, arg, arg, arg, arg, arg, arg, arg, arg, arg, arg))
	  testObj.apply(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17)
